...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link rel="stylesheet" type="text/css"
			href="${pageContext.request.contextPath}/styles/list_prod.css" />
		<link rel="stylesheet" type="text/css"
		...
		<script type="text/javascript"
			src="${pageContext.request.contextPath}/scripts/list_prod.js" /></script>
	</head>
	<body>
			...
			<div id="list">
				...
				<ul>
					<c:forEach var="news" items="${pageModel.page.list }">
						<li>
							<a href="${pageContext.request.contextPath}/content/detail.jhtml?cid=${news.id}&type=${param.type}"><img
									src="${pageContext.request.contextPath}${news.mainImagePath }" width="160px" height="120px"/><span
								class="name">${news.title }</span> </a>
						</li>
					</c:forEach>
					<li>
						<a href="#"><img src="${pageContext.request.contextPath}/images/pic_emp1.jpg" /><span class="name">LED防爆灯BLEDD5系列</span></a>
					</li>
					<li>
						<a href="#"><img src="${pageContext.request.contextPath}/images/pic_emp1.jpg" /><span class="name">LED防爆灯BLEDD5系列</span></a>
					</li>
